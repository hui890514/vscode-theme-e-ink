...
export const theme = <const>{
  ...
  diffInsertedBackground: [color.lightGray, lightColor.green, darkColor.green],
  diffRemovedBackground: [color.lightGray, lightColor.red, darkColor.red],
  ...
  diffInsertedBorder: [color.black, lightColor.green, darkColor.green],
  diffRemovedborder: [color.black, lightColor.red, darkColor.red],
