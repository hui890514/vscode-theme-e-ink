...
export const theme = <const>{
  ...
  selectionBackground: [color.white, lightColor.white, darkColor.gray],
  ...
  bracket2: [color.black, lightColor.purple, darkColor.pink],
  ...
  bracket6: [color.black, lightColor.brown, darkColor.white],
